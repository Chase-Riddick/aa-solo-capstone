...
class CreateCatch(FlaskForm):
    ...
    bait = StringField('bait', validators=[Length(max=255, message="The description of the catch must be 80 characters or less")])
    lure = StringField('lure', validators=[Length(max=255, message="The description of the catch must be 80 characters or less")])
