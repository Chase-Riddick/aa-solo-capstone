...
class CreateCatch(FlaskForm):
    ...
    bait = StringField('bait', validators=[Length(max=80, message="The description of the bait must be 80 characters or less")])
    lure = StringField('lure', validators=[Length(max=80, message="The description of the lure must be 80 characters or less")])
