...
function Footer() {
    return (
        <div className='footer'>
            <div className='footer-main'>
            <div><a href="https://reactjs.org/docs/getting-started.html" className='footerlink cardo' target="_blank">React JS</a></div>
            <div><a href="https://redux.js.org/" className='footerlink cardo' target="_blank">Redux</a></div>
            <div><a href="https://www.docker.com/" className='footerlink cardo' target="_blank">Docker</a></div>
            <div><a href="https://docs.python.org/3/index.html" className='footerlink cardo' target="_blank">Python</a></div>
            <div><a href="https://flask.palletsprojects.com/en/1.1.x/" className='footerlink cardo' target="_blank">Flask</a></div>
            <div><a href="https://www.postgresql.org/" className='footerlink cardo' target="_blank">PostgreSQL</a></div>
            <div><a href="https://www.sqlalchemy.org/" className='footerlink cardo' target="_blank">SQLAlchemy</a></div>
            <div><a href="https://alembic.sqlalchemy.org/en/latest/" className='footerlink cardo' target="_blank">Alembic</a></div>
            </div>
        </div>
